var Popup = {
  ...
  // Borders
  BorderThickness: 8,
  BorderImage: '/assets/images/admin/popup_border_background.png',
  BorderTopLeftImage: '/assets/images/admin/popup_border_top_left.png',
  BorderTopRightImage: '/assets/images/admin/popup_border_top_right.png',
  BorderBottomLeftImage: '/assets/images/admin/popup_border_bottom_left.png',
  BorderBottomRightImage: '/assets/images/admin/popup_border_bottom_right.png',
